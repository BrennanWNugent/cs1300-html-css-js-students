...
const updatePage = async () => {
  ...
  for (let i = 0; i < filteredArray.length; i++) {
    ...
    newElement.innerHTML = filteredArray[i].name + " has " + filteredArray[i].nutritions.calories.toString() + " calories";
    newElement.className = "fruit-item";

    const existingElement = document.getElementById('fruit-container');
